...
export class WorkOrderService {
  ...
  static async get(
    request: SearchWorkOrderRequest
  ): Promise<Pageable<WorkOrderResponse>> {
    const searchRequest = Validation.validate(
      WorkOrderValidation.SEARCH,
      request
    );
  ...
  static async startWorkOrderProcess(
    ...
    await WorkOrderProcessService.instance.startProcessingWorkOrder(
